...
3. No restriction on the upper limit! It is up to the teacher to decide what the total marks are. +
...
for the assessment in the second index as seen in list assess command.
