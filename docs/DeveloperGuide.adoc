...
** Cons: There is a need to check for an additional parameter in the same method, which may lengthen the code and cause minor 'arrow head' coding.
...
** Cons: An additional parameter will require a change in parser.
// end::attendance[]
