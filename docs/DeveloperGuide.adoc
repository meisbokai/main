...
.. Test case: `delete 0` +
   Expected: No person is deleted. Error details are shown in the status console. Console bar remains the same.
...
.. Test case: `add John Doe p/98765432 e/johnd@gmail.com a/311, Clementi Ave 2, #02-25 t/friends t/owesMoney` after the previous test case was performed. +
   Expected: No person is added. Error details are shown in the status console. Console bar remains the same.
